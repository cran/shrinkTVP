...
// do_shrinkTVP
List do_shrinkTVP(arma::vec y, arma::mat x, arma::vec a0, int niter, int nburn, int nthin, double c0, double g0, double G0, double cp, double np, double d1, double d2, double e1, double e2, bool learn_lambda2, bool learn_kappa2, double lambda2, double kappa2, bool learn_a_xi, bool learn_a_tau, double a_xi, double a_tau, double c_tuning_par_xi, double c_tuning_par_tau, double b_xi, double b_tau, double nu_xi, double nu_tau, bool display_progress, bool ret_beta_nc, bool store_burn, bool sv, double Bsigma_sv, double a0_sv, double b0_sv, double bmu, double Bmu, double y_test, arma::vec x_test, bool LPDS);
RcppExport SEXP _shrinkTVP_do_shrinkTVP(SEXP ySEXP, SEXP xSEXP, SEXP a0SEXP, SEXP niterSEXP, SEXP nburnSEXP, SEXP nthinSEXP, SEXP c0SEXP, SEXP g0SEXP, SEXP G0SEXP, SEXP cpSEXP, SEXP npSEXP, SEXP d1SEXP, SEXP d2SEXP, SEXP e1SEXP, SEXP e2SEXP, SEXP learn_lambda2SEXP, SEXP learn_kappa2SEXP, SEXP lambda2SEXP, SEXP kappa2SEXP, SEXP learn_a_xiSEXP, SEXP learn_a_tauSEXP, SEXP a_xiSEXP, SEXP a_tauSEXP, SEXP c_tuning_par_xiSEXP, SEXP c_tuning_par_tauSEXP, SEXP b_xiSEXP, SEXP b_tauSEXP, SEXP nu_xiSEXP, SEXP nu_tauSEXP, SEXP display_progressSEXP, SEXP ret_beta_ncSEXP, SEXP store_burnSEXP, SEXP svSEXP, SEXP Bsigma_svSEXP, SEXP a0_svSEXP, SEXP b0_svSEXP, SEXP bmuSEXP, SEXP BmuSEXP, SEXP y_testSEXP, SEXP x_testSEXP, SEXP LPDSSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type LPDS(LPDSSEXP);
    rcpp_result_gen = Rcpp::wrap(do_shrinkTVP(y, x, a0, niter, nburn, nthin, c0, g0, G0, cp, np, d1, d2, e1, e2, learn_lambda2, learn_kappa2, lambda2, kappa2, learn_a_xi, learn_a_tau, a_xi, a_tau, c_tuning_par_xi, c_tuning_par_tau, b_xi, b_tau, nu_xi, nu_tau, display_progress, ret_beta_nc, store_burn, sv, Bsigma_sv, a0_sv, b0_sv, bmu, Bmu, y_test, x_test, LPDS));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_shrinkTVP_do_shrinkTVP", (DL_FUNC) &_shrinkTVP_do_shrinkTVP, 41},
    {NULL, NULL, 0}
};
